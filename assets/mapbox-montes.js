(() => {
  ...
  function showFallback(message){ setStatus(message||'El mapa 3D no está disponible. Usa el mapa estático y las fichas inferiores.', true); const fallback=document.getElementById('mapa-estatico'); if(fallback) fallback.classList.add('is-visible'); }
