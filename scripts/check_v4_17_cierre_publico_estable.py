...
REQUIRED = {
    'README.md': ['V4.17', 'Cierre público'],
    'VERSION.txt': ['V4.17'],
    'CHANGELOG.txt': ['V4.17'],
    'ESTADO_ACTUAL.md': ['V4.17', 'cierre público estable'],
    ...
    'veredicto.html': ['V4.17', 'assets/v417-cierre-publico.css'],
    'assets/v417-cierre-publico.css': ['V4.17'],
    'INFORME_V4_17_CIERRE_PUBLICO_ESTABLE.md': ['Cierre público'],
...
if errors:
    ...
    sys.exit(1)
print('V4.17 CHECK PASS — cierre público estable preparado.')
